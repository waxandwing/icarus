...
/**
 * Arc keeps the calendar quiet until an object is selected. This function is
 * the single source of truth for which commands become available for that
 * selection in the current projection. It intentionally returns only actions
 * that are implemented end to end today.
 */
